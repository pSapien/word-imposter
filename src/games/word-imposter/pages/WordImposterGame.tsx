...
//   const { isConnected, send, currentUserId } = useSocket();
...
//   console.log("WordImposterGame::", roomState);
//   console.log("WordImposterGame::", gameState);
//   console.log({ isConnected, currentUserId, roomCode });

//   // Handle socket messages
//   useSocketHandler((message) => {
//     switch (message.type) {
//       case "room_joined": {
//         // When we join a room, set up the initial room state
//         const payload = message.payload;
//         setRoomState({
//           roomCode: payload.roomCode,
//           roomName: payload.roomName || `Room ${payload.roomCode}`,
//           hostId: payload.hostId,
//           members: [
//             {
//               profileId: currentUserId || "",
//               displayName: localStorage.getItem("playerName") || "Player",
//               role: payload.hostId === currentUserId ? "host" : "player",
//               isReady: false,
//             },
//           ],
//           status: "waiting",
...
//       case "room_updated": {
//         // Update room state when players join/leave
//         const payload = message.payload;
...
//   useEffect(() => {
//     if (isConnected && currentUserId && roomCode) {
//       send({
//         type: "join_room",
//         payload: { roomCode, role: "player" },
//       });
//     }
//   }, [isConnected, currentUserId, roomCode, send]);

//   const isHost = roomState?.hostId === currentUserId;
//   const isGameActive = roomState?.status === "active" && gameState;
...
//   const roomPlayers = roomState?.members.filter((m) => m.role !== "spectator") || [];
...
//                   ...p,
//                   isHost: p.profileId === roomState?.hostId,
