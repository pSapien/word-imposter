...
export default function ImposterBlitzRoom() {
  ...
  const gameInfo = getGameInfo("imposter-blitz")!;
  ...
  useSocketHandler({
    ...
    room_created: (payload) => {
      setIsLoading(false);
      navigate(`/game/imposter-blitz/room/${payload.roomName}`);
    },
    room_joined: (payload) => {
      setIsLoading(false);
      navigate(`/game/imposter-blitz/room/${payload.roomName}`);
        ...
        <Card variant="glass" className="backdrop-blur-xl">
          <CardContent className="p-4">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• A player is selected at random to give a word.</li>
              <li>• After all words are submitted, defend your choice.</li>
